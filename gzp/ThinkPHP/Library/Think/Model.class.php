 ...
 *
 * @method Model strict(bool $flag)
 * @method Model order(string|array $order)
 * @method Model alias(string $alias)
 * @method Model having(string $condition)
 * @method Model group(string $column)
 * @method Model lock(bool $flag)
 * @method Model distinct(bool $flag)
 * @method Model auto(bool $flag)
 * @method Model filter(string $func)
 * @method Model validate(array $type)
 * @method Model result(mixed $resultType) callback, json, xml
 * @method Model token(bool $flag)
 * @method Model index(string $indexName)
 * @method Model force(string $indexName)
 *
 * @method mixed count(string $column = '*')
