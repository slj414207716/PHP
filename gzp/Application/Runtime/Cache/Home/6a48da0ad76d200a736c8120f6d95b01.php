        ...
        <div id="content">
            <ul style="display:block;">
                <div class="aqsc">
                    <h3>任务公示</h3>
                    <div class="div">
                        <form action="/index.php/Home/Safety/renwugongshiadd" method="post">
                            <input name="time" type="hidden" value="<?php echo time() ?>"/>
                            <input name="childid" type="hidden" value="196"/>

                            <ul class="form">
                                <li>
                                    <div class="label">标　　题：</div>
                                    <div class="value"><input name="title" type="text"/></div>
                                </li>
                                <li>
                                    <div class="label">责任部门：</div>
                                    <div class="value"><input name="maindep" type="text"/></div>
                                </li>
                                <li>
                                    <div class="label">内容摘要：</div>
                                    <div class="value"><textarea name="maincontent"></textarea></div>
                                </li>
                                <li>
                                    <div class="label">详细内容：</div>
                                    <div class="value"><textarea name="content" id="ue_content" class="editor"></textarea></div>
                                </li>
                                <li>
                                    <div class="footer">
