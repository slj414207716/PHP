    ...
    <div id="content">
        	...
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<th scope="col">单位</th>
					<th scope="col">总人数</th>
                        <th scope="col">精神智力</th>
                        <th scope="col">言语听力</th>
                        <th scope="col">肢体</th>
                        <th scope="col" colspan="2">多重</th>
                ...
                <tr>
                    ...
                    <th scope="col"><a class="search1" href="<?php echo (HOST_NAME); ?>/Home/People/canjiYear">年度数据查询</a></th>
                </tr>
			</table>
        </div>
    </div>
