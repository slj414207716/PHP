...
<ul id="tab">
    ...
    <div id="content">
        	...
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<th scope="col">单位</th>
                    <th scope="col">户籍人口数</th>
                    <th scope="col">常住人口数</th>
                    <th scope="col">流动人口数</th>
				</tr>
				<?php  if (is_array($data)) { $__LIST__ = $data;} else { $__LIST__=array(); }if (empty($__LIST__)) { echo "" ; }if (count($__LIST__) > 0) { $i = 0; foreach ($__LIST__ as $key=>$v) { $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($v['hjsum']); ?></td>
                    <td><?php echo ($v['czsum']); ?></td>
                    <td><?php echo ($v['ldsum']); ?></td>
				</tr><?php } } ?>
			</table>
        </div>
    </div>
