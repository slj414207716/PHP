...
<div id="wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">公司属性管理</h1>
        </div>
    </div>

    <!--查询-->
    <form id="search" action="/index.php/Admin/Safety/gssx" method="get">
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group row">
                    <div class="col-lg-12">
                        <label>
                            关键字
                            <input name="key" type="text" value="<?php echo ($_GET['key']); ?>" class="form-control-inline">
                        </label>
                        <button type="submit" class="btn btn-sm btn-primary">查询</button>
                        <a href="/index.php/Admin/Safety/gssx_add" class="btn btn-sm btn-primary pull-right">添加</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover no-footer">
            <tr>
                ...
                <th style="text-align: center" scope="col">公司名称</th>
                <th style="text-align: center" scope="col">编辑</th>
            </tr>
            <?php foreach($data as $k=>$v): ?>
            <tr>
                <td align="center"><?php echo ++$a ?></td>
                <td align="center"><?php echo ($v['qymc']); ?></td>
                <td align="center">
                    <a href="gssx_edit/id/<?php echo ($v['id']); ?>">修改</a> |
                    <a onclick="return confirm('确定要删除吗？');" href="gssx_del/id/<?php echo ($v['id']); ?>">删除</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
