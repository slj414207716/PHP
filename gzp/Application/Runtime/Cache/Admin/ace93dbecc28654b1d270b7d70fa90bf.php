...
<form action="/Admin/People/edit/id/<?php echo ($id); ?>" method="post">
    <div class="panel panel-default">
        <div class="panel-body">
           
            <div class="form-group row">
                <label for="username" class="col-sm-2 col-form-label">年份</label>
                <div class="col-sm-10">
                    <input type="text" name="year" id="year" value="<?php echo ($data['year']); ?>" class="form-control" placeholder="年份">
                </div>
            </div>

            <div class="form-group row">
                <label for="password" class="col-sm-2 col-form-label">类型</label>
                <div class="col-sm-10">
                    <input type="text" name="month" id="month" value="<?php echo ($data['month']); ?>" class="form-control" placeholder="类型">
                </div>
            </div>

            <div class="form-group row">
                <label for="repassword" class="col-sm-2 col-form-label">总数</label>
                <div class="col-sm-10">
                    <input type="text" name="number" id="number" value="<?php echo ($data['number']); ?>" class="form-control" placeholder="数量">
                </div>
            </div>
