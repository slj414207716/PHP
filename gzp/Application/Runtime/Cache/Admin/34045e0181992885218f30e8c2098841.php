...
<form action="/index.php/Admin/Economic/jbzbEdit/id/<?php echo ($_GET['id']); ?>" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select name="sid" class="form-control">
                        ...
                        <option <?php if($data['sid'] == 1): ?>selected="selected"<?php endif; ?> value="1">地区生产总值</option>
                        <option <?php if($data['sid'] == 2): ?>selected="selected"<?php endif; ?> value="2">财政收入</option>
                        <option <?php if($data['sid'] == 3): ?>selected="selected"<?php endif; ?> value="3">规上工业总产值</option>
                        <option <?php if($data['sid'] == 4): ?>selected="selected"<?php endif; ?> value="4">固定资产投资</option>
                        <option <?php if($data['sid'] == 5): ?>selected="selected"<?php endif; ?> value="5">社会消费品零售额</option>
                        <option <?php if($data['sid'] == 6): ?>selected="selected"<?php endif; ?> value="6">使用内资</option>
                        <option <?php if($data['sid'] == 7): ?>selected="selected"<?php endif; ?> value="7">引进外资</option>
                    </select>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="date" name="year" id="year" class="form-control" value="<?php echo ($data['time']); ?>" />
                </div>
            </div>
            <div class="form-group row">
                <label for="plan" class="col-sm-2 col-form-label">计划任务</label>
                <div class="col-sm-10">
                    <input type="text" name="plan" id="plan" class="form-control" value="<?php echo ($data['plan']); ?>" placeholder="必须：填写计划任务数字部分，单位：亿元，例：100">
                </div>
            </div>
            <div class="form-group row">
                <label for="real" class="col-sm-2 col-form-label">实际完成</label>
                <div class="col-sm-10">
                    <input type="text" name="real" id="real" class="form-control" value="<?php echo ($data['real']); ?>" placeholder="选填：填写实际完成数字部分，单位：亿元，例：100">
                </div>
            </div>
        </div>
