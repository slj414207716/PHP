...
<div id="wrapper">
    ...
    <!--查询-->
    <form id="search" action="/index.php/Admin/Land/map1" method="get">
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group row">
                    <div class="col-lg-12">
                        ...
                        <a href="/index.php/Admin/Land/map1Add" class="btn btn-sm btn-primary pull-right">添加</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <form action="" method="post">
        <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover no-footer">
            <tr>
                <th style="text-align: center" scope="col">所属区域</th>
                <th style="text-align: center" scope="col">类型</th>
                <th style="text-align: center" scope="col">批文名称</th>
                <th style="text-align: center" scope="col">所需时间</th>
            ...
            <?php  if (is_array($data)) { $__LIST__ = $data;} else { $__LIST__=array(); }if (empty($__LIST__)) { echo "" ; }if (count($__LIST__) > 0) { $i = 0; foreach ($__LIST__ as $key=>$v) { $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center"><?php echo ($v['cycle']); ?></td>
                <td align="center"><?php echo date('Y-m-d',$v['addtime']);?></td>
                <td align="center">
                    <a href="/index.php/Admin/Land/map1Edit/id/<?php echo ($v['id']); ?>">修改</a> |
                    <a onclick="return confirm('确定要删除吗？');" href="/index.php/Admin/Land/map1Del/id/<?php echo ($v['id']); ?>">删除</a>
                </td>
            </tr><?php } } ?>
        </table>
    </form>
