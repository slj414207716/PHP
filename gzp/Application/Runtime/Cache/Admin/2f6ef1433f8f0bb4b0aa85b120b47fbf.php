...
<div id="wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">所属区域管理</h1>
        </div>
    </div>

    <!--查询-->
    <form id="search" action="/index.php/Admin/Safety/ssqy" method="get">
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group row">
                    <div class="col-lg-12">
                        ...
                        <a href="/index.php/Admin/Safety/ssqy_add" class="btn btn-sm btn-primary pull-right">添加</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <form action="" method="post">
        <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover no-footer">
            <tr>
                ...
                <th style="text-align: center" scope="col">所属区域名称</th>
            ...
            <tr>
                ...
                <td align="center">
                    <a href="ssqy_edit/id/<?php echo ($v['id']); ?>">修改</a> |
                    <a onclick="return confirm('确定要删除吗？');" href="ssqy_del/id/<?php echo ($v['id']); ?>">删除</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
