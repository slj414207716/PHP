			...
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li>
						...
						<ul class="nav nav-second-level">
							<li><a href="/index.php/Admin/News/lst"><i class=""></i> 对标上海</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">对标上海</h1>
    </div>
</div>
<div align="right">
    <a href="/Admin/News/add/sid/<?php echo ($sid); ?>"><h3>添加新闻</h3> </a>
</div>
            <!--列表-->
            ...
            <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover no-footer">
                <tr>
                    ...
                    <th style="text-align: center" width="20%" scope="col">新闻标题</th>
                    <th style="text-align: center" width="20%" scope="col">发表时间</th>
                ...
                <?php  if (is_array($data)) { $__LIST__ = $data;} else { $__LIST__=array(); }if (empty($__LIST__)) { echo "" ; }if (count($__LIST__) > 0) { $i = 0; foreach ($__LIST__ as $key=>$vo) { $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td align="center">
                            <a href="/Admin/News/alter/id/<?php echo ($vo['id']); ?>">修改</a>
                            <a onclick="return confirm('确定要删除吗？');" href="/Admin/News/del/id/<?php echo ($vo['id']); ?>">删除</a>
                        </td>
                    </tr><?php } } ?>
            </table>
...
<?php elseif (I('get.sid') ==2):?>
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">对标世界</h1>
    </div>
</div>
<div align="right">
    <a href="/Admin/News/add/sid/<?php echo ($sid); ?>"><h3>添加新闻</h3> </a>
