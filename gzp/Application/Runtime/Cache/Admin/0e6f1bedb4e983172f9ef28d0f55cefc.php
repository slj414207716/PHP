...
<div id="wrapper">
    ...
    <!--查询-->
    <form id="search" action="/index.php/Admin/Economic/zdxm" method="get">
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group row">
                    <div class="col-lg-12">
                        ...
                        <a href="/index.php/Admin/Economic/zdxmAdd" class="btn btn-sm btn-primary pull-right">添加</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <form action="" method="post">
        <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover no-footer">
            ...
            <?php  if (is_array($data)) { $__LIST__ = $data;} else { $__LIST__=array(); }if (empty($__LIST__)) { echo "" ; }if (count($__LIST__) > 0) { $i = 0; foreach ($__LIST__ as $key=>$v) { $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center">
                    <?php if($v['category'] == 1): ?>续建
                    <?php elseif($v['category'] == 2): ?>
                        新开工
                    <?php elseif($v['category'] == 3): ?>
                        推进前期<?php endif; ?>
                </td>
                <td align="center">
                    <a href="/index.php/Admin/Economic/zdxmPros/pid/<?php echo ($v['id']); ?>">添加进展</a>
                </td>
                <td align="center">
                    <a href="/index.php/Admin/Economic/zdxmEdit/id/<?php echo ($v['id']); ?>">修改</a> |
                    <a onclick="return confirm('确定要删除吗？');" href="/index.php/Admin/Economic/zdxmDel/id/<?php echo ($v['id']); ?>">删除</a>
                </td>
            </tr><?php } } ?>
        </table>
    </form>
