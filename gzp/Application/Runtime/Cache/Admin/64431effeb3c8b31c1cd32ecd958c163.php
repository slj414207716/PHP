...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">角色列表</h1>
            ...
            <!--查询-->
            <form id="search" action="/index.php/Admin/Role/lst" method="get">
            ...
            <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover no-footer">
                <tr>
                    ...
                    <th style="text-align: center" width="20%" scope="col">角色名称</th>
                    <th style="text-align: center" width="60%" scope="col">权限</th>
                ...
                <?php foreach($data as $k=>$v): ?>
                    <tr>
                        ...
                        <td align="center">
                            <a href="edit/id/<?php echo $v['role_id'] ?>">修改</a> |
                            <a onclick="return confirm('确定要删除吗？');" href="delete/id/<?php echo $v['role_id'] ?>">删除</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </table>
