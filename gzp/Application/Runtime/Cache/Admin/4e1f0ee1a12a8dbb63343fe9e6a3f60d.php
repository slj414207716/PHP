    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <?php  if (is_array($roleData)) { $__LIST__ = $roleData;} else { $__LIST__=array(); }if (empty($__LIST__)) { echo "" ; }if (count($__LIST__) > 0) { $i = 0; foreach ($__LIST__ as $key=>$v) { $mod = ($i % 2 );++$i;?><label class="checkbox-inline">
                            <input type="checkbox" name="role_id[]" value="<?php echo ($v['id']); ?>" <?php if(in_array($v['id'], $roleIds)): ?>checked<?php endif; ?>> <?php echo ($v['name']); ?>
                        </label><?php } } ?>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="username" id="username" class="form-control" value="<?php echo ($data['username']); ?>" placeholder="用户名">
                </div>
            </div>
            <div class="form-group row">
